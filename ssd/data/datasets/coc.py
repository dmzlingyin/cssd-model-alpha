"""
all of this code is same as ./voc.py, just the name is diffrent.
the structure of coc(class object classes) is also same as VOC2007/VOC2012z
author: Lv Wenchao
date: 2021-08-04
"""
...
class COCDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, data_dir, split, transform=None, target_transform=None, keep_difficult=False):
        ...
        self.ids = COCDataset._read_image_ids(image_sets_file)
